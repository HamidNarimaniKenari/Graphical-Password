<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckCuedClickPoint.aspx.cs"
    Inherits="Users_CheckCuedClickPoint" %>
                                ...
                                <ContentTemplate>
                                    <table cellspacing="0" class="ContentTable">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <asp:ImageButton ID="ibtnPasswordImage" runat="server" OnClick="ibtnPasswordImage_Click"
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <asp:ListBox ID="ListBox1" runat="server" CssClass="HideColumn" Height="150px"></asp:ListBox>

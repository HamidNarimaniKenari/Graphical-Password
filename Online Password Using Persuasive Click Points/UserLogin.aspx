<%@ Page Language="C#" MasterPageFile="~/VisitorMP.master" AutoEventWireup="true"
    CodeFile="UserLogin.aspx.cs" Inherits="UserLogin" Title="Online Graphical Password" %>
        ...
        <tr>
            <td align="center">
                ...
                <table cellspacing="0" class="LoginTable" width="300">
                    ...
                    <tr>
                        <td>
                         <center>   <table cellspacing="0" class="DetailsTable">
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td style="margin-left: 40px">
                                        <asp:LinkButton ID="lnkForgotPassword" runat="server" PostBackUrl="~/ForgetPassword.aspx"
                                            CssClass="LinkButton1">Forgot your password?</asp:LinkButton>
                                    </td>
                                </tr>
                            </table></center>
                        </td>
